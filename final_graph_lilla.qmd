...
album_pop_fig.update_layout(
    ...
    yaxis_title=None,  
    yaxis=dict(showticklabels=False, title_standoff=10, automargin=True),  # Hide y-axis tick labels
...
lover_album_data = taylor_songs_filtered[taylor_songs_filtered['album_name'].str.lower() == 'lover']
...
Popularity of singles on the most popular Taylor Swift album, "Lover"
